<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="Song.Web.manage.AddUser" %>
                    ...
                    <table class="tablecss1">
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="Button1" runat="server" Text="确认添加" OnClick="Button1_Click" CssClass="inp1" />
                            </td>
                        </tr>
                    </table>
                    <!--主体内容区 结束-->
