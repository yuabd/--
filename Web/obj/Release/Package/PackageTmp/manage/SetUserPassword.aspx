<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetUserPassword.aspx.cs"
    Inherits="Song.Web.manage.SetUserPassword" %>
                ...
                <td valign="top" bgcolor="#F7F8F9">
                    ...
                    <table class="tablecss1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtLoginName" runat="server" Width="200px" Enabled="true"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
