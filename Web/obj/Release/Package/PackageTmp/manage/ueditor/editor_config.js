...
(function () {
    ...
    URL = window.UEDITOR_HOME_URL || "/manage/ueditor/"; //这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["source","undo","redo","highlightcode","template","directionalityltr","directionalityrtl","selectall","bold","italic","forecolor","backcolor","underline","strikethrough","fontsize","touppercase","tolowercase","spechars","superscript","subscript","emotion","fontfamily","pasteplain","justifyleft","justifycenter","justifyright","justifyjustify","insertimage","imagenone","imageleft","imageright","imagecenter","wordimage","background","anchor","paragraph","indent","rowspacingbottom","rowspacingtop","lineheight","inserttable","deletetable","mergedown","mergeright","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable","insertvideo","music","attachment","map","gmap","insertunorderedlist","insertorderedlist","unlink","link","autotypeset","removeformat","formatmatch","cleardoc","pagebreak","scrawl","customstyle","snapscreen","insertframe","date","time","horizontal","blockquote","webapp","searchreplace","print","preview","help","fullscreen"]]
