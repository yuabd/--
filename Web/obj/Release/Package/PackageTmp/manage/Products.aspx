<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="Song.Web.manage.Products"
            ...
            <tr>
                ...
                <td valign="top" bgcolor="#F7F8F9">
                    ...
                    <table border="1" class="tablecss1">
                        ...
                        <tr <%=ShowField("producttitle") %>>
                            <td class="tdMargin">
                                <asp:Literal ID="Literal3" runat="server" Text="产品名称："></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox ID="title" runat="server" Width="500px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr <%=ShowField("entitle") %>>
                            <td class="tdMargin">
                        ...
                        <tr <%=ShowField("productno") %>>
                            <td class="tdMargin">
                                <asp:Literal ID="Literal5" runat="server" Text="产品规格："></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox ID="productno" runat="server" Width="500px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr <%=ShowField("Material") %>>
                            <td class="tdMargin">
                        ...
                        <tr <%=ShowField("price") %>>
                            <td class="tdMargin">
                                <asp:Literal ID="Literal7" runat="server" Text="价格："></asp:Literal>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="tdMargin">
                                <asp:Literal ID="Literal9" runat="server" Text="优惠价："></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox ID="text2" runat="server" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr <%=ShowField("sale") %>>
                            <td class="tdMargin">
                                <asp:Literal ID="Literal8" runat="server" Text="颜色："></asp:Literal>
                            </td>
                            <td>
                        ...
                        <tr <%=ShowField("productphoto") %> style="display: none">
                            <td class="tdMargin">
                                信息图片：
                            </td>
                            <td>
...
<iframe id="Iframe3" src="SongEdit/editor.htm?id=encontent&ReadCookie=0" frameborder="0" scrolling="no" width="100%" height="400"></iframe>--%>
                    ...
                    <table class="tablecss1">
                        <tr>
                            ...
                            <td>
                                &nbsp;信息搜索&nbsp;
                                <asp:DropDownList ID="searchtype" runat="server" AutoPostBack="false" OnSelectedIndexChanged="searchtype1_SelectedIndexChanged">
                                </asp:DropDownList>
                                &nbsp;
                                <asp:DropDownList ID="searchtype2" runat="server" AutoPostBack="True" Visible="False">
                                    <asp:ListItem Value="0">选择分类</asp:ListItem>
                                </asp:DropDownList>
                    ...
                    <table class="tablecss1">
                        <tr>
                            <td class="tabletop" colspan="12" style="height: 30px">
                                <center>
                                    <%=ClassName %>
                                </center>
                            </td>
